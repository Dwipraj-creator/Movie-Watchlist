...
import profilePic from "../pic/472341787_1766745024175698_135769034888050281_n.jpg";
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        ...
        <section className="text-center">
          ...
          <p className="text-zinc-400 text-lg md:text-xl mt-8 max-w-3xl mx-auto leading-relaxed">
            MovieWatch helps movie lovers discover incredible films, build
            watchlists, organize favourites, and enjoy a beautiful cinematic
            browsing experience.
          </p>
        </section>
        ...
        <section className="mt-28">
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-500 max-w-2xl mx-auto mt-6 text-lg">
              A modern streaming-inspired interface built for discovery,
              organization, and immersive browsing.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="group relative overflow-hidden rounded-3xl border border-zinc-800 bg-gradient-to-b from-zinc-900 to-zinc-950 p-10 hover:border-red-500 transition-all duration-500">
              ...
              <div className="relative">
                <div className="bg-red-500/10 w-fit p-4 rounded-2xl mb-8">
                  <Sparkles size={34} className="text-red-500" />
                </div>

                <h3 className="text-3xl font-bold mb-5">Smart Discovery</h3>

                <p className="text-zinc-400 leading-relaxed text-lg">
                  Explore trending movies, hidden gems, critically acclaimed
                  masterpieces, and unforgettable cinematic experiences.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-3xl border border-zinc-800 bg-gradient-to-b from-zinc-900 to-zinc-950 p-10 hover:border-purple-500 transition-all duration-500">
              ...
              <div className="relative">
                <div className="bg-purple-500/10 w-fit p-4 rounded-2xl mb-8">
                  <Crown size={34} className="text-purple-400" />
                </div>
                ...
                <p className="text-zinc-400 leading-relaxed text-lg">
                  Save favourites, organize watchlists, and create your own
                  curated library of cinematic treasures.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-3xl border border-zinc-800 bg-gradient-to-b from-zinc-900 to-zinc-950 p-10 hover:border-emerald-500 transition-all duration-500">
              ...
              <div className="relative">
                ...
                <h3 className="text-3xl font-bold mb-5">Seamless Experience</h3>

                <p className="text-zinc-400 leading-relaxed text-lg">
                  Built with performance, responsiveness, and elegant UI design
                  for effortless movie exploration.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mt-28">
          <div className="rounded-[40px] overflow-hidden border border-zinc-800 bg-gradient-to-r from-zinc-900 via-zinc-950 to-zinc-900 p-12 shadow-2xl">
            ...
            <p className="text-zinc-400 text-xl leading-relaxed max-w-4xl">
              We believe discovering movies should feel exciting, immersive, and
              effortless. MovieWatch was created to help users organize what
              they love, explore new stories, and enjoy a premium entertainment
              experience.
            </p>
          </div>
        </section>
        ...
        <section className="mt-28 text-center">
          ...
          <div className="max-w-4xl mx-auto rounded-[40px] border border-zinc-800 bg-zinc-900/70 backdrop-blur-xl p-12">
            <img
              src={profilePic}
              alt="Dwipraj Dey"
              className="mx-auto h-32 w-32 rounded-full border border-red-500/40 object-cover shadow-[0_0_40px_rgba(239,68,68,0.35)]"
            />

            <h3 className="text-4xl font-bold mt-8">Dwipraj Dey</h3>
